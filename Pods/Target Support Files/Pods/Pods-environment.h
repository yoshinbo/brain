...
// GLDTween
#define COCOAPODS_POD_AVAILABLE_GLDTween
#define COCOAPODS_VERSION_MAJOR_GLDTween 0
#define COCOAPODS_VERSION_MINOR_GLDTween 0
#define COCOAPODS_VERSION_PATCH_GLDTween 2
